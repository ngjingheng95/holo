...
import com.google.ar.sceneform.samples.chromakeyvideo.dialog.PickerDialog;
import com.google.ar.sceneform.samples.chromakeyvideo.dialog.SimplePickerDialog;
import com.google.ar.sceneform.samples.chromakeyvideo.options.AspectRatioItem;
import com.google.ar.sceneform.samples.chromakeyvideo.options.Commons;
import com.google.ar.sceneform.samples.chromakeyvideo.options.SizeItem;
        ...
        if (supportedSizes != null) {
            SimplePickerDialog<SizeItem> dialog = SimplePickerDialog.create(new PickerDialog.ActionListener<SizeItem>() {
                ...
                public void onDoneClick(PickerDialog<SizeItem> dialog) {
                    ...
                    if (mode == Values.MODE_VIDEO) {
                        photographer.setVideoSize(new Size(1920, 1080));
                    } else {
