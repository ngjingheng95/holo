...
public class CreateArTutorial extends AppCompatActivity {
    private ViewFlipper viewFlipper;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.create_ar_tutorial);
    ...
    public void onClickBackBtn(View view){
        Intent intent=new Intent(CreateArTutorial.this, CameraActivity.class);
