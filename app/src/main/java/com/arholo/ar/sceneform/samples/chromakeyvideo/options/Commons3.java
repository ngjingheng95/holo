package com.arholo.ar.sceneform.samples.chromakeyvideo.options;
...
public class Commons3 {
    ...
    public static final String MEDIA_DIR = Environment.getExternalStorageDirectory().getPath() + "/0/dev/Characters";
